...
### Apart from the scope of this project, I made these little contributions
  - [PR #2275 | URL encode faultData in bug report](https://github.com/mit-cml/appinventor-sources/pull/2275) ![](https://img.shields.io/github/pulls/detail/state/mit-cml/appinventor-sources/2275)
  - [PR #2263 | Exclude markdown files from AndroidRuntime.jar](https://github.com/mit-cml/appinventor-sources/pull/2263) ![](https://img.shields.io/github/pulls/detail/state/mit-cml/appinventor-sources/2263)
  - [PR #2252 | Make OdeLog to print to brower console also](https://github.com/mit-cml/appinventor-sources/pull/2252) ![](https://img.shields.io/github/pulls/detail/state/mit-cml/appinventor-sources/2252)
