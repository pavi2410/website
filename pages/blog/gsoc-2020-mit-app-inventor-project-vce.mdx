...
import image from '../../public/assets/blog/gsoc-2020-mit-app-inventor-project-vce/Cowsay_demo.png'
...
export const meta = {
  ...
  tags: ["GSoC", "MIT", "App Inventor", "Project", "VCE"],
}

[![GSoC Project Page](https://img.shields.io/badge/-GSoC%20Project%20Page-blueviolet)](https://summerofcode.withgoogle.com/projects/#4749864480538624) [![GSoC 2020 Proposal for Visible Component Extensions](https://img.shields.io/badge/-GSoC%202020%20Proposal-orange)](https://docs.google.com/document/d/14FwGfVMQcyDReeWCPSqFbMWSbW6ZsYbl3mRBsPEzBnQ/edit?usp=sharing) [![Design Document](https://img.shields.io/badge/-Design%20Document-red)](https://docs.google.com/document/d/1BV1lGCNtYjP0H0dxUyLcVPnO91ztke-1VAH4EnRdDYc/edit?usp=sharing) [![Documentation](https://img.shields.io/badge/Documentation-WIP-555?labelColor=brightgreen)](https://docs.google.com/document/d/17uMiZ5RuwC3u9J1e2oVUIGNPVHA8Mp2umDka6pXJ244/edit?usp=sharing) [![Community Feedback](https://img.shields.io/badge/-Community%20Feedback-darkblue)](https://community.appinventor.mit.edu/t/gsoc-request-for-feedback-on-design-doc-for-visible-component-extension/9705?u=pavi2410)
...
<Image src={image} alt="Cowsay demo" />
...
### My Exterience with Google Summer of Code 2020 ![GSoC logo](https://summerofcode.withgoogle.com/static/img/summer-of-code-logo.svg)
